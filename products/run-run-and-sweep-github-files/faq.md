...
If experiments are queued for a long time it could be a sign that instance type requested is not in the availability zone; reach out on slack or open a github issue if you see this: [https://github.com/gridai/gridai/issues](https://github.com/gridai/gridai/issues)
