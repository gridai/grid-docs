...
![](<../.gitbook/assets/sess\_2 (4) (3) (1) (1) (4).gif>)
...
{% embed url="https://grid-docs.s3.us-east-2.amazonaws.com/run_cifar5.mp4" %}
...
![](<../.gitbook/assets/artifacts (1).gif>)

### CLI

Finally... there is a really amazing experience with interactive sessions and run submission via the CLI.

{% content-ref url="typical-workflow-cli-user.md" %}
[typical-workflow-cli-user.md](typical-workflow-cli-user.md)
{% endcontent-ref %}
