...
| `--cluster` | text | The cluster id to list datastores for. | `essie-fsx-cluster-2` |
...
| `--cluster` | text | cluster id to create the datastore on. (Bring Your Own Cloud Customers Only). | `essie-fsx-cluster-2` |
| `--help` | boolean | Show this message and exit. | `False` |
...
| `--cluster` | text | cluster id to delete the datastore from. (Bring Your Own Cloud Customers Only). | `essie-fsx-cluster-2` |
| `--help` | boolean | Show this message and exit. | `False` |
...
| Name | Type | Description | Default |
| ---- | ---- | ----------- | ------- |
| `--cluster` | text | Cluster ID whence the instance types needs to be fetched. (Bring Your Own Cloud Customers Only). | `essie-fsx-cluster-2` |
| `--help` | boolean | Show this message and exit. | `False` |
...
| `--cluster` | text | N/A | `essie-fsx-cluster-2` |
...
| Name | Type | Description | Default |
| ---- | ---- | ----------- | ------- |
| `--cluster` | text | Cluster to run on | `essie-fsx-cluster-2` |
