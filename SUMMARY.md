...
* [⚡Datastores](products/add-data-to-grid-datastores/README.md)
  * [⚡CLI](products/add-data-to-grid-datastores/global-cli-configs/README.md)
    * [Advanced config](products/add-data-to-grid-datastores/global-cli-configs/advanced-config.md)
    * [API reference](products/add-data-to-grid-datastores/global-cli-configs/cli-api/README.md)
      * [grid artifacts](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-artifacts.md)
      * [grid credentials](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-credentials.md)
      * [grid datastore](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-datastores.md)
      * [grid docs](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-docs.md)
      * [grid delete](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-delete.md)
      * [grid history](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-history.md)
      * [grid session](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-interactive.md)
      * [grid logs](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-logs.md)
      * [grid login](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-login.md)
      * [grid run](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-train.md)
      * [grid status](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-status.md)
      * [grid stop](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-cancel.md)
      * [grid user](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-user.md)
      * [grid version](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-version.md)
      * [grid view](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-view.md)
      * [grid ssh-keys](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-ssh-keys.md)
      * [grid sync-env](products/add-data-to-grid-datastores/global-cli-configs/cli-api/grid-sync-env.md)
    * [Virtual Environments](products/add-data-to-grid-datastores/global-cli-configs/virtual-environments.md)
    * [Windows support](products/add-data-to-grid-datastores/global-cli-configs/using-grid-with-windows-subsystem-for-linux-wsl.md)
